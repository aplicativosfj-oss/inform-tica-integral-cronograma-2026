...
import alunoHeroImg from "@/assets/laboratorio-moderno.jpg";
      ...
      <div className="relative z-10">
        ...
        <section className="mx-auto max-w-6xl px-4 pt-6 sm:px-6 sm:pt-8">
          <div className="relative overflow-hidden rounded-3xl border border-border/60 shadow-xl">
            <SiteImage
              src={alunoHeroImg}
              alt="Laboratório de informática moderno, com computadores organizados em fileiras"
              width={1600}
              height={500}
              className="h-[220px] w-full sm:h-[260px] lg:aspect-[21/8] lg:h-auto"
              loading="eager"
              decoding="async"
              fetchPriority="high"
            />
            ...
            <div className="absolute inset-0 flex items-center p-4 sm:p-6 lg:p-8">
              <div className="flex max-w-lg flex-col gap-2.5 rounded-2xl border border-white/25 bg-white/10 p-4 shadow-2xl backdrop-blur-xl sm:gap-3 sm:p-6">
                ...
                <p className="text-balance text-xs text-white/90 sm:text-sm">
                  Encontre a sua turma, depois clique no seu nome para acessar suas atividades de
                  informática.
                </p>
              </div>
            </div>
              ...
              {turmas.map((turma) => {
                ...
                return (
                  <Link
                    ...
                    className="group flex flex-col gap-3 rounded-2xl border border-border/60 bg-card p-4 shadow-sm transition-all duration-200 ease-out hover:-translate-y-0.5 hover:border-primary/40 hover:shadow-md"
                  >
                    <span
