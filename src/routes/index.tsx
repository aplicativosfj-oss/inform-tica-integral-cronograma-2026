      ...
      <div className="relative z-10">
        ...
        <RevealSection className="mx-auto max-w-6xl px-4 py-8 sm:px-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <div className="col-span-1 lg:col-span-2 rounded-2xl border border-border/60 bg-gradient-to-br from-blue-50 to-blue-100/50 dark:from-blue-950/30 dark:to-blue-900/20 p-6">
              <div className="flex items-start gap-4">
                <Gamepad2 className="mt-0.5 size-6 shrink-0 text-blue-600" />
                <div>
                  <h3 className="text-lg font-semibold text-foreground">Aprendizado digital</h3>
                  <p className="mt-2 text-sm text-muted-foreground">
                    Tecnologia que estimula o raciocínio, criatividade e engajamento através de ferramentas modernas acessíveis a todos.
                  </p>
                </div>
              </div>
            </div>
            <FeatureCard
              ...
              description="Distribuição justa e automatizada dos grupos."
            />
            <FeatureCard
              icon={<Timer className="size-5" />}
              iconClassName="bg-amber-500/10 text-amber-600"
              title="Cronômetro ao vivo"
              description="Contagem regressiva em tempo real."
            />
            <FeatureCard
              icon={<ShieldCheck className="size-5" />}
              iconClassName="bg-emerald-500/10 text-emerald-600"
              title="Painel de gestão"
              description="Controle total com acesso restrito."
            />
          </div>
        </RevealSection>
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
        <div className="mb-8 max-w-2xl">
          ...
          <p className="mt-1 text-sm text-blue-100/70">
            Clique um dia para ver as turmas agendadas.
          </p>
        </div>
