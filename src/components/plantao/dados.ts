...
export const MISSOES: Missao[] = [
  ...
  },
  {
    ...
    resumo: "Pilote a Honda CB650R contra cinco adversários em uma corrida de tempo e posição.",
    tipo: "moto",
    cenario: "cenario-cidade.webp",
    tempo: [90, 90, 90],
    meta: [1, 3, 5],
    dica: "A pista é limpa: use as curvas e as faixas de turbo para conquistar o melhor tempo.",
  },
  {
    id: "maratona",
