  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <section className="flex flex-col gap-3">
        <div>
          <h3 className="text-sm font-semibold text-foreground">Escolha uma porcentagem</h3>
          <p className="text-xs text-muted-foreground">
            Arraste a barra, digite o número ou clique nos quadradinhos: os quatro desenhos mudam
            juntos.
          </p>
        </div>
      ...
      <section className="flex flex-col gap-2">
        ...
        <div className="grid grid-cols-3 gap-2">
          <div className="rounded-xl border border-border bg-background p-3 text-center">
            ...
            <p className="mt-1 text-[11px] text-muted-foreground">de cada 100</p>
          </div>
          <div className="rounded-xl border border-border bg-background p-3 text-center">
          ...
          <div className="rounded-xl border border-border bg-background p-3 text-center">
            ...
            <p className="mt-1 text-[11px] text-muted-foreground">é só dividir por 100</p>
          </div>
        </div>
      </section>
      ...
      <section className="flex flex-col gap-2">
        ...
        <p className="rounded-xl bg-primary/10 p-3 text-center text-lg font-bold text-primary">
          {num(parte)}
        </p>
        <p className="text-xs text-muted-foreground">
          Três caminhos diferentes chegam nesse mesmo número — use o que for mais fácil para você:
        </p>
      ...
      <section className="flex flex-col gap-3">
        <h3 className="text-sm font-semibold text-foreground">Onde isso aparece na vida</h3>
        ...
        <div className="flex flex-col gap-2 rounded-xl border border-border bg-background p-3">
          ...
          <p className="text-xs text-muted-foreground">
            ...
            <b className="text-foreground">{Math.round(p)}%</b> da meta — mexa na barra lá em cima
            para ver a turma avançar.
          </p>
          <Regua p={p} />
        </div>
      </section>
      ...
      <p className={cn("text-center text-[11px] text-muted-foreground")}>
        Dica de quem ensina: 50% é sempre metade, 25% é a metade da metade e 10% é só andar com a
